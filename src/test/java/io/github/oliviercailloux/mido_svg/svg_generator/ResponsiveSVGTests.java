...
public class ResponsiveSVGTests {
  ...
  /**
   * Tests that an SVG in A4 format is responsive by calculating the objects position by hand
   * 
  ...
  /**
   * Tests that an SVG in A4 format without Licence is responsive by calculating the objects
   * position by hand
   * 
   * The test allow an uncertainty for the position because GitHub seems to make different rounded
   * 
  ...
  /**
   * Tests that an SVG in A4 format without Master and Courses is responsive by calculating the
   * objects position by hand
   * 
   * The test allow an uncertainty for the position because GitHub seems to make different rounded
   * 
   * @result the position calculated by hand and verified by Google Inspection in the browser should
  ...
  /**
   * Tests that an SVG in A4 format with only Formations is responsive by calculating the objects
   * position by hand
   * 
   * The test allow an uncertainty for the position because GitHub seems to make different rounded
   * 
