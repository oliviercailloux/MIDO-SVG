      ...
      public void widgetSelected(SelectionEvent e) {
        ...
        try {
          ...
          if (btnCheckButtonA3.getSelection()) {
            settings = new Settings(affFormationLicence, affFormationMaster, affResponsable,
                affAdmission, affSubject, affTeacher, affPrereq, "A3");
           ...
           */
            ...
            settings = new Settings(affFormationLicence, affFormationMaster, affResponsable,
                affAdmission, affSubject, affTeacher, affPrereq, "A4");

          }
          /*
           * Else If this radio button is selected the user get to choose his own values height,
           * width
           */
            ...
            settings = new Settings(affFormationLicence, affFormationMaster, affResponsable,
                affAdmission, affSubject, affTeacher, affPrereq, width, height);
          }
