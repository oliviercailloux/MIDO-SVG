...
import io.github.oliviercailloux.mido_svg.controller.ControllerJAXB;
...
public class GUISVGTAGSupprimer {
  ...
  private Map<String, io.github.oliviercailloux.mido_svg.university.components.Course> map =
      data.getSubjects();
  ...
  public Map<String, io.github.oliviercailloux.mido_svg.university.components.Course> getMap() {
    return map;
  }
  ...
  public void
      setMap(Map<String, io.github.oliviercailloux.mido_svg.university.components.Course> map) {
    this.map = map;
  }
  ...
  /**
   * This subroutine is used to get the subjects linked to a specific tag which is given in param in
   *
   * @param specificTag
   * @return
   */
