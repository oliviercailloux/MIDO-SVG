...
public class GUISVGTAGSupprimer {
	...
	private Map<String, io.github.oliviercailloux.mido_svg.university.components.Subject> map = data.getSubjects();
	...
	public void setMap(Map<String, io.github.oliviercailloux.mido_svg.university.components.Subject> map) {
		this.map = map;
	}
