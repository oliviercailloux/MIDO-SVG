...
public class Master extends Formation {
  ...
  /**
   *
   * @param name is the name of the licence
   * @param i is the year : 4 or 5. Example M1 -> 4, M2 -> 5
   */
   ...
   * @param name is the name of the licence
   * @param i is the year : 4 or 5. Example M1 -> 4, M2 -> 5
   * @param x is is the abscissa position you want to set
   * @param y is the intercept position you want to set
   */
