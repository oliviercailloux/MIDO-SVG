...
/**
 * This class is corresponding to the Department of the formation. It contains : title (the name of
 * departement) and listOfFormations (the formations available in this Departement)
 *
 */
