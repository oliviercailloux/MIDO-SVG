...
public class Licence extends Formation {
  ...
  /**
   *
   * @param string is the name of the licence
   * @param k is the year : 1 2 or 3. Example L1 -> 1, L3 -> 3
   */
   ...
   * @param string is the name of the licence
   * @param k is the year : 1 2 or 3. Example L1 -> 1, L3 -> 3
   * @param posX is the abscissa position you want to set
   * @param posY is the intercept position you want to set
   */
