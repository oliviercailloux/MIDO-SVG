...
/**
 * This class correspond to a formation of any kind It is an abstract class, which helps a future
 * group to create other kind of formations, but with same "default data" : a title, a grade (1-2-3
 * for example)
 */
public abstract class Formation {
  ...
  /**
   * This is to create a link for a formation. It has to be used with the method drawString() from
   * Graphics2D
   *
   * @param link
   */
  public void setFullNameWithLink(String link) {
    ...
    this.fullNameWithLink =
        "<a xlink:href=\"" + link + "\" target=\"_blank\">" + this.getFullName() + "</a>";
